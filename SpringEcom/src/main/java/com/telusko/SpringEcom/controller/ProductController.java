...
public class ProductController {
    ...
    public ResponseEntity<String> generateProductDescription(@RequestParam String name, @RequestParam String category) {
        try {
            String response = productService.generateDescription(name, category);
    ...
    public ResponseEntity<?> generateImage(@RequestParam String name, @RequestParam String category, @RequestParam String description) {
        try {
            byte[] responseImage = productService.generateImage(name, category, description);
            return new ResponseEntity<>(responseImage, HttpStatus.OK);
        } catch (Exception e) {
            return new ResponseEntity<>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
